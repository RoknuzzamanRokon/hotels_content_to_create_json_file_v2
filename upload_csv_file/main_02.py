...
# Define the data types for the columns (updated for new columns)
dtype_dict = {
    'UnicaId': str,
    'Name': str,
    'Latitude': float,
...
# Convert 'ModifiedOn' to datetime if necessary (optional, based on the columns you need)
# Handle any additional data conversions as required
