...
class HotelDataFetcher:
    ...
    def fetch_hotel_data(self, provider_hotel_id, provider_family):
        payload = json.dumps({
...
def save_json_files_follow_systemId(folder_path, tracking_file_path):
    ...
    while remaining_ids:
        ...
        try:
            ...
            url = url = "https://hotelmapping.vervotech.com/api/3.0/content/GetProviderContentByProviderHotelIds"
            account_id = "gtrs"
            api_key = "b0ae90d7-2507-4751-ba4d-d119827c1ed2"
            vervotech_ids = [systemid]
            print(vervotech_ids)
            provider_preferences = ["DOTW"]
            fetcher = HotelDataFetcher(url, account_id, api_key)
            
            response_data = fetcher.fetch_hotel_data(vervotech_ids, provider_preferences)
            print(response_data)
            data_list = fetcher.create_content_follow_hotel_id(response_data)
...
#     url = "https://hotelmapping.vervotech.com/api/3.0/content/GetProviderContentByVervotechIds"
#     account_id = "gtrs"
#     api_key = "b0ae90d7-2507-4751-ba4d-d119827c1ed2"

#     vervotech_ids = [41616583]
#     provider_preferences = ["DOTW"]

#     fetcher = HotelDataFetcher(url, account_id, api_key)
#     try:
#         response_data = fetcher.fetch_hotel_data(vervotech_ids, provider_preferences)
#         hotel_summary = fetcher.get_hotel_summary(response_data)
#         print(hotel_summary)
